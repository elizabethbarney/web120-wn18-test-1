...
#EDIT THE FOLLOWING:
$toAddress = "elizabeth.m.barney@gmail.com";  //place your/your client's email address here
$toName = "Elizabeth Barney"; //place your client's name here
...
?>
	...
	<div>	
		<fieldset>
			<legend>What Web Services Intrest You?</legend>
			...
			<input type="checkbox" name="Interested_In[]" value="Lollipops" /> Higher Ranking on a Search Engine <br />
      ...
      <div>	
		<label>
			Please describe your organization in a few sentences:<br /><textarea name="Comments" cols="36" rows="4" placeholder="What are you all about?" tabindex="60"></textarea>
		</label>
	</div>
        
        <div>	
		<fieldset>
			<legend>Do you have a slogan or tagline that clearly describes what you offer in terms of benefits or features?</legend>
